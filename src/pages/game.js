        ...
        <div class="modal-content bg-dark text-white">
          ...
          <div class="modal-body">
            ...
            <div class="winner-loser mb-3 p-2 rounded d-flex align-items-center justify-content-between">
              ...
              <img src="" class="rounded-circle me-2" id="classic-winner-image" alt="Winner" style="width: 50px; height: 50px;">
            ...
            <div class="winner-loser mb-4 p-2 rounded d-flex align-items-center justify-content-between">
              ...
              <img src="" class="rounded-circle me-2" id="classic-loser-image" alt="Loser" style="width: 50px; height: 50px;">
